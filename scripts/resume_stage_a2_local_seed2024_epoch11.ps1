# tập lệnh/resume_stage_a2_local_seed2024_epoch11.ps1
# Tiếp tục Canonical Seed 2024 từ checkpoint Epoch 10 -> Thực thi Epoch 11
...
$ckptSha = "b2fc754c3d85aae8374bcf53ef2034804a25e3536be499062a8c4e19db33de55"
...
Write-Host "   RESUMING CANONICAL SEED 2024 (EPOCH 11)                " -ForegroundColor Yellow
Write-Host "==========================================================" -ForegroundColor Cyan
