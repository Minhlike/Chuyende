# tập lệnh/resume_stage_a2_local_seed7_epoch9.ps1
# Tiếp tục Canonical Seed 7 từ checkpoint Epoch 8 -> Thực thi Epoch 9
...
$ckptSha = "3283c316842b5eeb33de7a266ad05ec314a81905eef28f406baba692a7f3075f"
...
Write-Host "   RESUMING CANONICAL SEED 7 (EPOCH 9)                    " -ForegroundColor Yellow
Write-Host "==========================================================" -ForegroundColor Cyan
