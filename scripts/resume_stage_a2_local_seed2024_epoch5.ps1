# tập lệnh/resume_stage_a2_local_seed2024_epoch5.ps1
# Tiếp tục Canonical Seed 2024 từ checkpoint Epoch 4 -> Thực thi Epoch 5
...
$ckptSha = "162630be868025032bf75a4b523e1615f13580df60cff2920eab75048376dea7"
...
Write-Host "   RESUMING CANONICAL SEED 2024 (EPOCH 5)                 " -ForegroundColor Yellow
Write-Host "==========================================================" -ForegroundColor Cyan
