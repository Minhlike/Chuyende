# tập lệnh/resume_stage_a2_local_seed1337_epoch2.ps1
# Tiếp tục Canonical Seed 1337 từ checkpoint Epoch 1 -> Thực thi Epoch 2
...
$ckptSha = "80232e70eb953e5f9cb312338c1a43c85326da6bdd85cb6c7b4d0bf35a29cbc8"
...
Write-Host "   RESUMING CANONICAL SEED 1337 (EPOCH 2)                 " -ForegroundColor Yellow
Write-Host "==========================================================" -ForegroundColor Cyan
