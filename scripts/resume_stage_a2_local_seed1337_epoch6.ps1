# tập lệnh/resume_stage_a2_local_seed1337_epoch6.ps1
# Tiếp tục Canonical Seed 1337 từ checkpoint Epoch 5 -> Thực thi Epoch 6
...
$ckptSha = "1eddd2adbec5c29928ee8d8721e5caddb6f72e71d8e2e387e1741a3b8c61f7b4"
...
Write-Host "   RESUMING CANONICAL SEED 1337 (EPOCH 6)                 " -ForegroundColor Yellow
Write-Host "==========================================================" -ForegroundColor Cyan
