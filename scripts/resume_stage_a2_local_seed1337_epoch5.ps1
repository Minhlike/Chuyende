...
# Resume Canonical Seed 1337 from Epoch 4 Checkpoint -> Execute Epoch 5
...
$ckptSha = "0dd1bd3ff6e3cab534b70fc6b11f545aa170b7e3c7f8bc735289b875609f2938"
...
Write-Host "   RESUMING CANONICAL SEED 1337 (EPOCH 5)                 " -ForegroundColor Yellow
Write-Host "==========================================================" -ForegroundColor Cyan
