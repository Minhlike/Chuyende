# tập lệnh/resume_stage_a2_local_seed7_epoch5.ps1
# Tiếp tục Canonical Seed 7 từ checkpoint Epoch 4 -> Thực thi Epoch 5
...
$ckptSha = "0889f1cb47cbacf1dbd31aead9813bd80195c6e070f10d4efeecbea581d0a2da"
...
Write-Host "   RESUMING CANONICAL SEED 7 (EPOCH 5)                    " -ForegroundColor Yellow
Write-Host "==========================================================" -ForegroundColor Cyan
