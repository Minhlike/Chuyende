# tập lệnh/resume_stage_a2_local_seed2024_epoch7.ps1
# Tiếp tục Canonical Seed 2024 từ checkpoint Epoch 6 -> Thực thi Epoch 7
...
$ckptSha = "c6d077c98daaacc2b756922d427af9c4e689d131ac0821f73311e768800a1466"
...
Write-Host "   RESUMING CANONICAL SEED 2024 (EPOCH 7)                 " -ForegroundColor Yellow
Write-Host "==========================================================" -ForegroundColor Cyan
