# tập lệnh/resume_stage_a2_local_seed1337_epoch9.ps1
# Tiếp tục Canonical Seed 1337 từ checkpoint Epoch 8 -> Thực thi Epoch 9
...
$ckptSha = "c460e8ddd156448c40d83e4ca09d7f264107f6442527fe697e77f3100093cb38"
...
Write-Host "   RESUMING CANONICAL SEED 1337 (EPOCH 9)                 " -ForegroundColor Yellow
Write-Host "==========================================================" -ForegroundColor Cyan
